...
La décomposition est réalisée sur l'échantillon d'apprentissage. On utilise
...
tests. On garde aussi la différenciation saisonnière afin de construire un
...
Les corrélogrammes sont tracés sur la série stationnaire. On utilise les
retards jusqu'à 40 pour l'ACF et jusqu'à 30 pour la PACF, ce qui respecte l'idée
...
La série présente une saisonnalité de période 12. on cherche donc un modèle :
\[
...
On trouve que la série des ventes de voitures possède une tendance croissante
